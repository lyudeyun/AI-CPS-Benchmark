...
% https://github.com/natchi92/ARCH-COMP/blob/d29d5e5f36d7b2e4ac792a756ea444d770bf9c09/2017/FALS/staliro/staliro_arch_competition_experiments.m
...
%---------------------------------------------------------------------   
    ...
    elseif opt_id==3
        cp_array = []; 
        pulse='mid_high' %'mid_low' for -_-, 'mid_high' for _-_
        opt.optimization_solver = 'SA_Taliro'; 
        opt.optim_params.dispStart= 0.9;
        opt.optim_params.dispAdap = 2;        
        % Parameterization:
